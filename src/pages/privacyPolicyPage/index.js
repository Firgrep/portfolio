        ...
        <>
            ...
            <main className="container">
                <div style={{marginBottom: "100px"}}>
                    ...
                    <p>React Router stores a value for the scroll restoration in the sessionStorage, which will be erased upon closing the browser or the tab.</p>
                    <p>Apart from these, no other cookies, local- or session storage has been made use of, either explicitly intended or implicitly through the tools and technologies to the knowledge of the website creator. This site is intended mainly for read-only (apart from interactions and the email functionality on the contacts page) and should therefore not require to store any information on the user-agent's local system beyond what has already been made mention of above. Should an issue or misunderstanding arise, please contact the site creator at the <NavLink to="/contact"> contact page</NavLink>.</p>
                </div>
            </main>
        </>
    );
